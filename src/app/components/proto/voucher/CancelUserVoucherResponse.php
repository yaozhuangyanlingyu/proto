 ...
 *取消用户优惠券-返回
 *
 * Generated from protobuf message <code>voucher_types.CancelUserVoucherResponse</code>
 */
class CancelUserVoucherResponse extends \Google\Protobuf\Internal\Message
{
    /**
