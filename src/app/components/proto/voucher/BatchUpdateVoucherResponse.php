 ...
 *批量更新优惠券总数量-返回
 *
 * Generated from protobuf message <code>voucher_types.BatchUpdateVoucherResponse</code>
 */
class BatchUpdateVoucherResponse extends \Google\Protobuf\Internal\Message
{
    /**
