 ...
 * 获取售卖优惠券列表
 *
 * Generated from protobuf message <code>voucher_types_read.SellVoucherListRequest</code>
 */
class SellVoucherListRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 售卖优惠券列表
     *
