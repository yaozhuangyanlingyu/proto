 ...
 * 用户已领取的全场可用券
 *
 * Generated from protobuf message <code>voucher_types_read.GetUnclaimedVoucherRequest</code>
 */
class GetUnclaimedVoucherRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 用户ID
     *
