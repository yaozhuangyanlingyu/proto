...
/**
 * Generated from protobuf message <code>voucher_types_read.GetVoucherByCatIdAndBrandIdRequest</code>
 */
class GetVoucherByCatIdAndBrandIdRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 分类id
     *
