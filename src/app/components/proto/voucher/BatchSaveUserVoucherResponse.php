 ...
 *批量保存用户优惠券-返回
 *
 * Generated from protobuf message <code>voucher_types.BatchSaveUserVoucherResponse</code>
 */
class BatchSaveUserVoucherResponse extends \Google\Protobuf\Internal\Message
{
    /**
