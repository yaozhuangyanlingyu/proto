...
/**
 * Generated from protobuf message <code>voucher_types_read.CheckCalPriceVoucherListByTimePointResponse</code>
 */
class CheckCalPriceVoucherListByTimePointResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $msg = '';
    /**
     * Generated from protobuf field <code>repeated .voucher_types_read.VoucherData data = 3;</code>
     */
    private $data;
     ...
     *     @type string $msg
     *     @type \app\components\proto\voucher\VoucherData[]|\Google\Protobuf\Internal\RepeatedField $data
     * }
     */
