...
/**
 * Generated from protobuf message <code>voucher_types_read.GetReadBeanExchangeVoucherData</code>
 */
class GetReadBeanExchangeVoucherData extends \Google\Protobuf\Internal\Message
{
    /**
