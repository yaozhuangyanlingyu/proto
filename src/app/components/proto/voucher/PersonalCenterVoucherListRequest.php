 ...
 * WWW个人中心-获取优惠券列表
 *
 * Generated from protobuf message <code>voucher_types_read.PersonalCenterVoucherListRequest</code>
 */
class PersonalCenterVoucherListRequest extends \Google\Protobuf\Internal\Message
{
    /**
