 ...
 *批量更新已领取优惠券库存-返回
 *
 * Generated from protobuf message <code>voucher_types.BatchUpdateDrawCountResponse</code>
 */
class BatchUpdateDrawCountResponse extends \Google\Protobuf\Internal\Message
{
    /**
